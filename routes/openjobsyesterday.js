...
router.get('/openjobsyesterday', async (req, res, next) => {
  const month = [
    "01", "02", "03", "04",
    "05", "06", "07", "08",
    "09", "10", "11", "12",
  ...
  var yesterday = dateArray[3] + "-" + month[monthIndex] + "-" + day;
  //connect to the database
  let req_company_name = req.query.name
